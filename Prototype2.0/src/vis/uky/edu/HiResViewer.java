...
public class HiResViewer extends Activity implements OnClickListener, OnTouchListener, OnSeekBarChangeListener{
	...
	public void onCreate(Bundle savedInstanceState){
        ...
        highRes = new ImageView(this);
        
        highRes.setImageBitmap(b);
        
        highRes.setOnTouchListener(this);
        ...
        highRes.setLayoutParams(params);
        
        main.addView(highRes);
